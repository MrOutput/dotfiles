...
syn keyword javaScriptBoolean		true false length
...
hi def link jsop		        Keyword
hi def link constant		        Boolean
hi def link funcName		        Type
...
hi def link javaScriptBranch		Keyword
...
hi def link javaScriptNull		Boolean
